...
Well, it has a 774 bytes brainfuck interpreter written in Ruby with Treetop. Kinda large, but better than most other ruby brainfuck interpreters, but the most important, it is _extremelly_ easy to understand if you're learning TreeTop.
